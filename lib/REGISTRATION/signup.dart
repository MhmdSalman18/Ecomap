...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> _handleSubmit() async {
    ...
    if (!_isUsernameValid ||
      ...
      String message = await apiService.registerUser(_usernameController.text, _emailController.text, _passwordController.text);
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const UploadDpPage(title: '',)), // Replace with your next page
                  );
                },
              ),
            ],
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                        color: _isUsernameValid ? Colors.white54 : Colors.red),
                  ),
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10),
                    borderSide: BorderSide(
                        color:
                            _isUsernameValid ? Colors.greenAccent : Colors.red),
                  ),
                  prefixIcon:
                      const Icon(Icons.account_box, color: Colors.greenAccent),
                ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                          color:
                              _isEmailValid ? Colors.greenAccent : Colors.red)),
                  prefixIcon:
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                          color:
                              _isPasswordValid ? Colors.white54 : Colors.red)),
                  focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10),
                      borderSide: BorderSide(
